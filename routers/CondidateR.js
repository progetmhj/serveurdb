...
app.get('/find/:_id', function (req, res) {
    ...
    condidate.findById(req.params._id, function (err, result) {
        ...
        result.first_name=req.query.first_name
        result.last_name=req.query.last_name
        result.birth_date=req.query.birth_date
        result.nationality=req.query.nationality
        result. gender=req.query. gender
        result.country=req.query.country
        result.yofexp=req.query.yofexp
        result.fields=req.query.fields
        result.level=req.query.level
        result.education.push(req.query.education)
        result.language.push(req.query.language)
        result.experience.push(req.query.experience)
        result.training.push(req.query.training)
        result.skills.push(req.query.skills)
...
app.get('/finde/:_id', function (req, res) {
